    ...
    LaunchedEffect(key1 = true) {
        ...
        val pathToAnimate = Path().apply {
            ...
            */
            ...
            //cubic-bezier(.71,0,.29,1)
            val c2x = startDestination.x + (0.71 * horizontalDistance)
            val c2y = startDestination.y + (0.71 * verticalDistance)
            val c1x = startDestination.x + (0.29 * horizontalDistance)
            val c1y = startDestination.y + (0.29 * horizontalDistance)
